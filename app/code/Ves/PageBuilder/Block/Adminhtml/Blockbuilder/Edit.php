 ...
 */
namespace Ves\PageBuilder\Block\Adminhtml\Blockbuilder;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Ves_PageBuilder::block_save')){
    	...
    	if ($this->_isAllowedAction('Ves_PageBuilder::block_delete') && $this->_coreRegistry->registry('ves_pagebuilder')->getId()) {
